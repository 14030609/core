                            ...
                            <nav class="menu_main_nav_area menu_hover_fade">
                                <div class="menu_main_inner">
                                    ...
                                    <ul id="menu_main" class="sc_layouts_menu_nav menu_main_nav">
                                        ...
                                        <li class="menu-item current-menu-item"><a href="contacts2.blade.php"><span>Contacts</span></a></li>
                                    </ul>
                                </div>
                            </nav>
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div id="sc_googlemap_744_wrap" class="sc_googlemap_wrap">
                                                    <div id="sc_googlemap_744" class="sc_googlemap sc_googlemap_default" data-zoom="14" data-style="greyscale">
                                                        <div id="sc_googlemap_744_1" class="sc_googlemap_marker" data-latlng="" data-address="176 W, New York, NY 10014" data-description="" data-title="HR Advisor" data-icon="images/map-marker.jpg"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="trx_addons_column-1_3">
                                                                    <div class="sc_form_info_item sc_form_info_item_address">
                                                                        ...
                                                                        <span class="sc_form_info_data">
                                                                            <span>176 W street name,
                                                                            <br />New York, NY 10014</span>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div class="trx_addons_column-1_3">
                                ...
                                <aside class="column-1_4 widget widget_nav_menu">
                                    ...
                                    <div class="menu-footer-navigate-container">
                                        <ul id="menu-footer-navigate" class="menu">
                                            ...
                                            <li class="menu-item"><a href="contacts2.blade.php">Contacts</a></li>
                                        </ul>
                                    </div>
                                </aside>
                                <aside class="column-1_4 widget widget_text">
