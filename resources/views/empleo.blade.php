...
<head>
    <title>Core - Consultoría y reclutamiento de capital humano</title>
    <meta charset="UTF-8">
...
<div class="body_wrap">
    <div class="page_wrap">
                                ...
                                <ul id="menu_main" class="sc_layouts_menu_nav menu_main_nav">
                                    ...
                                    <!--li class="menu-item menu-item-has-children"><a href="#"><span>Blog</span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item"><a href="single-post.blade.php"><span>Post With Comments</span></a></li>
                                        </ul>
                                    </li-->
                                </ul>
                            </div>
        ...
        <div class="page_content_wrap scheme_default" style="background-color:#0374a6; color: #ffffff">
            <div class="content_wrap">
                <div class="content" >
                                            ...
                                            <div class="sc_form sc_form_modern">
                                                <form class="sc_form_form" method="post" action="includes/sendmail.php">
                                                    ...
                                                    <div class="sc_form_fields" >
                                                        <h5  style="color: #ffffff">Datos personales</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_2" >
                                                                <label class="sc_form_field sc_form_field_name required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="name" aria-required="true" placeholder="Nombre completo">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Número de identificación iNE">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Lugar y fecha de nacimiento">
                                                                        </span>
                                                                </label>
                                                            </div>
                                                            <div class="sc_form_message trx_addons_column-1_2">
                                                                <label class="sc_form_field sc_form_field_name required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="name" aria-required="true" placeholder="Dirección personal">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Teléfono de contacto">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Correo electrónico">
                                                                        </span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <h5 style="color: #ffffff">Formación académica</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_3" style="width:33%;min-width:33%;">
                                                                <label class="sc_form_field sc_form_field_name required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="name" aria-required="true" placeholder="Institución primaria">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Institución secundaria">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Institución profesional">
                                                                        </span>
                                                                </label>
                                                            </div>
                                                            <div class="sc_form_message trx_addons_column-1_3" style="width:33%;min-width:33%;">
                                                                <label class="sc_form_field sc_form_field_name required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="date" name="name" aria-required="true" placeholder="Fecha" style="padding:0.8em 1.2em;">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="date" name="email" aria-required="true" placeholder="Fecha" style="padding:0.8em 1.2em;">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                            ...
                                                            <div class="sc_form_message trx_addons_column-1_3" style="width:33%;min-width:33%;">
                                                                <label class="sc_form_field sc_form_field_name required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="name" aria-required="true" placeholder="Lugar">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <input type="text" name="email" aria-required="true" placeholder="Lugar">
                                                                        </span>
                                                                </label>
                                                                <label class="sc_form_field sc_form_field_email required">
                                                                        <span class="sc_form_field_wrap">
                                                        ...
                                                        <h5 style="color: #ffffff" >Formación complementaria</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_1">
                                                                <label class="sc_form_field sc_form_field_message required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <textarea name="message" aria-required="true" placeholder="Estudios y seminarios que amplían y complementan tu formación, indicando las fechas, el centro y el lugar donde fueron realizados."></textarea>
                                                                        </span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <h5 style="color: #ffffff">Experiencia Profesional</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_1">
                                                                <label class="sc_form_field sc_form_field_message required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <textarea name="message" aria-required="true" placeholder="Contratos, convenios y colaboraciones. Experiencia laboral realizada incluyendo las prácticas de los estudios que puedan ser de interés para la empresa que desea contratarte. No olvides señalar las fechas, la empresa dónde trabajaste y las funciones y tareas llevadas a cabo."></textarea>
                                                                        </span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <h5  style="color: #ffffff">Idiomas</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_1">
                                                                <label class="sc_form_field sc_form_field_message required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <textarea name="message" aria-required="true" placeholder="Idiomas que conoces y tu nivel."></textarea>
                                                                        </span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <h5 style="color: #ffffff">Informática</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_1">
                                                                <label class="sc_form_field sc_form_field_message required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <textarea name="message" aria-required="true" placeholder="Señala aquellos conocimientos informáticos que poseas: sistemas operativos, procesadores de texto, hojas de cálculo, bases de datos, diseño gráfico, internet, etc."></textarea>
                                                                        </span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <h5 style="color: #ffffff">Otros Datos de Interés</h5>
                                                        <div class="trx_addons_columns_wrap">
                                                            <div class="sc_form_details trx_addons_column-1_1">
                                                                <label class="sc_form_field sc_form_field_message required">
                                                                        <span class="sc_form_field_wrap">
                                                                            <textarea name="message" aria-required="true" placeholder="En este último apartado señala todos aquellos aspectos que no han sido incluídos todavía, tales como: Carné de conducir, disponibilidad, etc."></textarea>
                                                                        </span>
                                                                </label>
                                                            </div>
                                                        </div>
