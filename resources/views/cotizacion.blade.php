...
<body
    class="page contpg body_style_wide scheme_default blog_mode_page sidebar_hide remove_margins header_style_header-2 header_title_on no_layout vc_responsive">
...
<div class="body_wrap">
    ...
    <div class="page_wrap">
        ...
        <header class="top_panel top_panel_style_2 scheme_default">
            ...
            <div class="top_panel_title_wrap">
                <div class="top_panel_title_wrap">
                    <img src="images/contacto1.jpg" alt="" style=" height: auto; width: 100%;" >
                </div>
                </div>
        </header>
    ...
    <div class="page_content_wrap scheme_default " style=" background-color: #0374a6">
            <div class="content_wrap">
                <div class="content">
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="sc_form sc_form_modern">
                                                <form class="sc_form_form" method="post" action="includes/sendmail.php">
                                                    <div > <h1 style="color: #ffffff">Cotiza aquí!!</h1></div>
                                                    <br>
    ...
    <div style="	margin-top: 5em; background-color: #202020">
    </div>
...
<script type='text/javascript'
        src='http://maps.google.com/maps/api/js?key=AIzaSyD2-LD0jQTHC2bthfrrrdlOzQiQUoGIS6o'></script>
