                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    ...
                                                    <h1>Evaluaciones psicométricas</h1>
                                                    <p>
                                                        Apoyamos a conocer las competencias, personalidad y habilidades del perfil de sus candidatos <br>
                                                        Honestidad y Valores <br>
                                                        Personalidad <br>
                                                        Liderazgo <br>
                                                        Estilos de aprendizaje <br>
                                                        Adaptabilidad social <br>
                                                        Habilidades de Ventas <br>
                                                        Entre otras
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    ...
                                                    <p>
                                                        Ayudamos a las organizaciones a desarrollar su capacidad para cambiar y lograr una mayor productividad y motivación de los colaboradores, disminuir la rotación de personal, resolver problemas de Desarrollo Organizacional. <br>
                                                        Aplicación de encuestas de clima organizacional<br>
                                                        Creación de estructuras empresariales, así como perfiles de puesto<br>
                                                        Revisión y creación de estudio de sueldos y bandas salariales<br>
                                                        Capacitaciones<br>
                                                        Diseño y creación de evaluaciones de desempeño<br>
                                                        Diseño de estrategias de retención de talento Humano <br>
                                                        Diseño de planes de carrera para el capital humano del negocio.
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="vc_empty_space empty_2-5">
