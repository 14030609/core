    ...
    <div class="body_wrap">
        <div class="page_wrap">
                    ...
                    <div class="menu_main_wrap clearfix">
                        <div class="content_wrap">
                            <a class="logo scheme_dark" href="/">
                                <img src="images/LOGOTIPO- PNG-AZUL-CORE.png" alt="">
                            </a>
            ...
            <div class="page_content_wrap scheme_default" style="background-color: #e6e4e4;">
                ...
                <div style="background-color: #0374a6; color: #ffffff; padding: 2em" >
                    <div class="content_wrap" >
                            ...
                            <div class="wpb_column vc_column_container vc_col-sm-6">
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>En CORE Consultoría y Reclutamiento de Capital Humano ofrecemos soluciones innovadoras, contamos con el personal certificado, las mejores herramientas tecnológicas para ejecutar los procesos de atracción de talento, garantizamos la confiabilidad y absoluta transparencia dentro de nuestros procesos, con la finalidad de que nuestros clientes se puedan enfocar en lo realmente importante: Su propio negocio.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="content" >
                        ...
                        <article class="post_item_single page hentry" >
                            <div class="post_content entry-content">
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid bg_position_center vc_custom_1474881086363 vc_row-has-fill fullwidth_1 scheme_dark">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                                    ...
                                                    <div class="wpb_column vc_column_container vc_col-sm-7">
                                                        <div class="vc_column-inner ">
                                                            <div class="wpb_wrapper">
                                                                <div class="sc_blockquote sc_blockquote_default">
                                                                    <h2 class style="color: #FFF;-webkit-text-stroke: 1px black;">
                                                                        <br>
                                                                        <br>
                                                                        <br>
                                                                        <br>
                ...
                <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid" style="opacity:1; display: flex; align-items: stretch">
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-6" style="margin: auto; display: flex; align-items: stretch;">
                        <div class="vc_column-inner" style="margin: auto; display: flex; align-items: stretch; padding: 0em">
                            <div class="wpb_wrapper" style="display: flex; align-items: stretch;">
                                <div class="wpb_single_image wpb_content_element vc_align_left"  >
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin: auto; display: flex; align-items: stretch;">
                                        <ol class="carousel-indicators">
                                            <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
                                            <li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
                                            <li data-target="#carouselExampleIndicators" data-slide-to="2"></li>
