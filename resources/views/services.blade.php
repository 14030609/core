...
<head>
    <title>Sobre Nosotros &#8211; CORE</title>
    <meta charset="UTF-8">
                    ...
                    <div class="content_wrap">
                        <div class="top_panel_title">
                            <div class="page_title">
                                <h3 class="page_caption">Acerca de nosotros</h3>
                            </div>
                            <div class="breadcrumbs">
                                <a class="breadcrumbs_item home" href="/">Inicio</a>
                                <span class="breadcrumbs_delimiter"></span>
                                <span class="breadcrumbs_item current">Nosotros</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content">
                        <article class="post_item_single page hentry">
                            <div class="post_content entry-content">
                                            ...
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <h1>Soluciones en capital
                                                            <br>humano</h1>
                                                        <p>
                                                            Somos una consultora de recursos humanos que ofrece el servicio
                                                            de asesoría y servicios<br> especializados en selección de personal técnico, gerencial, directivo y estratégico,
                                                            <br>orientada la calidad y resultados.
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sc_item_button sc_button_wrap">
                                                    <a href="about.blade.php" class="sc_button sc_button_default sc_button_size_large sc_button_icon_left">
                                                        ...
                                                        <div class="sc_skills_column trx_addons_column-1_2">
                                                            <div class="sc_skills_item_wrap">
                                                                <div class="sc_skills_item">
                                                                    ...
                                                                    <div class="sc_skills_total" data-start="0" data-stop="1" data-step="5" data-max="536" data-speed="15" data-duration="3819" data-ed="">0</div>
                                                                </div>
                                                        ...
                                                        <div class="sc_skills_column trx_addons_column-1_2">
                                                            <div class="sc_skills_item_wrap">
                                                                <div class="sc_skills_item">
                                                                    ...
                                                                    <div class="sc_skills_total" data-start="0" data-stop="1" data-step="5" data-max="536" data-speed="18" data-duration="371" data-ed="">0</div>
                                                                </div>
                                                        ...
                                                        <div class="sc_skills_column trx_addons_column-1_2">
                                                            <div class="sc_skills_item_wrap">
                                                                <div class="sc_skills_item">
                                                                    ...
                                                                    <div class="sc_skills_total" data-start="0" data-stop="1" data-step="5" data-max="536" data-speed="25" data-duration="3315" data-ed="">0</div>
                                                                </div>
                                                        ...
                                                        <div class="sc_skills_column trx_addons_column-1_2">
                                                            <div class="sc_skills_item_wrap">
                                                                <div class="sc_skills_item">
                                                                    ...
                                                                    <div class="sc_skills_total" data-start="0" data-stop="1" data-step="5" data-max="536" data-speed="16" data-duration="784" data-ed="">0</div>
                                                                </div>
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1467641241328 vc_row-has-fill">
                                    <div class="wpb_column vc_column_container vc_col-sm-4">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space empty_4-5 hide_on_mobile">
                                                    <span class="vc_empty_space_inner"></span>
                                                </div>
                                                <div class="sc_testimonials sc_testimonials_default swiper-slider-container slider_swiper slider_no_controls" data-slides-min-width="150">
                                                    <div class="sc_testimonials_slider sc_item_slider slides swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="sc_testimonials_item">
                                                                <div class="sc_testimonials_item_content">
                                                                    <p>Bajos costos en el servicio!</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="vc_empty_space empty_4 hide_on_mobile">
                                                    <span class="vc_empty_space_inner"></span>
                                                </div>
                                                <div class="vc_empty_space empty_6 hide_on_tablet">
                                                    <span class="vc_empty_space_inner"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wpb_column vc_column_container vc_col-sm-8 vc_hidden-xs">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_single_image wpb_content_element vc_align_left  vc_custom_1468592892644">

                                                    <figure class="wpb_wrapper vc_figure">
                                                        <div class="vc_single_image-wrapper vc_box_border_grey">
                                                            <img src="images/5.jpg" class="vc_single_image-img attachment-full" alt="" />
                                                        </div>
                                                    </figure>
                                                </div>
                                                <div class="vc_empty_space empty_6 hide_on_mobile">
                                                    <span class="vc_empty_space_inner"></span>
                                                </div>
                                            </div>
                                        </div>
