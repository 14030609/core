        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="m-b-20">
                        <div class="btn-group">
                            <button id="table-edit_new" class="btn btn-sm btn-dark" data-toggle="modal" id="mediumButton" data-target="#modal-comentario"><i class="fa fa-plus"></i> Agregar comentario</button>
                        </div>
                    </div>

                    <table class="table table-bordered yajra-datatable" id="tablacomentario">
                        <thead>
                        <tr>
                            <th>Post</th>
                            <th>Comentario</th>
...
<script>
    ...
    $(document).on('click', '.edit', function (e) {
        $("#editar_comentario").show();
        $('#guardar-comentario').hide()
    ...
    $('#editar_comentario').click(function(e)
    {
        ...
        let url = "{{ route('comentario-update',':id') }}";
    ...
    $(document).on('click', '#table-edit_new', function (e) {
        $('#comentario').val('');
        $("#guardar_comentario").show();
        $("#editar_comentario").hide();
        bandera_editar = false;
    });

    $('#boton-preguntar-borrar').click(function (e) {
        e.preventDefault();
        let url = "{{ route('comentario-delete-id',':id') }}";
        url = url.replace(':id', clave_edit);
        $.ajax({
            url: url,
            type: 'delete',
