  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="m-b-20">
              <div class="btn-group">
                  <button id="table-edit_new" class="btn btn-sm btn-dark" data-toggle="modal" id="mediumButton" data-target="#modal-categoria"><i class="fa fa-plus"></i> Agregar categoria</button>
              </div>
          </div>

          <table class="table table-bordered yajra-datatable" id="tablaCategoria">
              <thead>
              <tr>
                  <th>Categoria</th>
                  <th>Action</th>
...
<script>
    ...
    $('#guardar-categoria').click(function(e)
    {
        ...
        $.ajax({
            ...
            success:function(datos)
            {
                ...
                alert("Se ha registrado correctamente la categoria");
    ...
    $('#editar_categoria').click(function(e)
    {
        ...
        let url = "{{ route('categoria-update',':id') }}";
    ...
    $('#boton-preguntar-borrar').click(function (e) {
        ...
        let url = "{{ route('categoria-delete-id',':id') }}";
        url = url.replace(':id', clave_edit);
        $.ajax({
            url: url,
            type: 'delete',
